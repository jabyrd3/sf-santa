  ...
  client.connect()
    .then(() => {
      client.query({
        ...
        values: [req.body.name, req.body.fbname, req.body.email, req.body['street-address'], null, uuidv4(), req.body['address-line-2'], req.body.city, req.body.state, req.body.zip, req.body.international||false, req.body.country || null],
      })
      .then(result => {
